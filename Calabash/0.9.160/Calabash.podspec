...
this software.'
  ...
  s.source   = { :http => 'file:///usr/local/Cellar/rbenv/0.4.0/versions/1.9.3-p448/lib/ruby/gems/1.9.1/gems/calabash-cucumber-0.9.160/staticlib/calabash.framework.zip'}
  s.prepare_command = 'pwd; ls; tar -xf file.zip;'
